...
public class Quiz_2_14Test {
    ...
    interface RequestHandler {
        ...
        default RequestHandler compose(RequestHandler handleAfter) {
            return req -> handleAfter.handle(handle(req));
        }
    }
    ...
    final static RequestHandler commonRequestHandler = wrapInTransactionTag
            .compose(createDigest).compose(wrapInRequestTag);// !!! write the combining of existing handlers here
